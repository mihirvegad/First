...
<body class="main-bg">
        <div class="login-container text-c animated flipInX">
                <div>
                    ...
                    <p class="text-whitesmoke">User Detail</p>
                <div class="container-content">
                   <p id="thank-you-message">
  Congratulation,You have succesfully complete Login.
 </p>
                    <form class="margin-t" action="authforuserside" method="post">
                        ...
                        <a class="text-darkyellow" href="abc"><small>Sign Up</small></a>
                      
                    </form>
                    <p class="margin-t text-whitesmoke"><small> Codersfarm &copy; 2023</small> </p>
                </div>
            </div>
